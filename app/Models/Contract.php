...
{
    use HasFactory;
    protected $fillable = ['no_vendor', 'vendor_name', 'no_contract', 'contract_name', 'contract_type', 'contract_date', 'contract_price', 'contract_file', 'kom', 'contract_start_date', 'contract_end_date', 'meeting_notes', 'contract_status', 'contract_penalty', 'pengawas', 'current_status'];
    protected $appends = [
        'weeks',
        'durasi_mpp',
        'monitoring_progress',
