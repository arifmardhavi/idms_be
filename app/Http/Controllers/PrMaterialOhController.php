...
use App\Models\PrMaterialOh;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class PrMaterialOhController extends Controller
{
    /**
    ...
    {
        $pr_material = PrMaterialOh::orderBy('id', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            $pr_material = PrMaterialOh::create($validatedData);
    ...
    {
        $pr_material = PrMaterialOh::find($id);
    ...
    {
        $pr_material = PrMaterialOh::with(['readiness_material_oh'])->where('readiness_material_oh_id', $id)->orderby('id', 'desc')->get();
