...
use App\Models\NotifMaterialOh;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class NotifMaterialOhController extends Controller
{
    /**
    ...
    {
        $notif_material = NotifMaterialOh::orderBy('id', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            $notif_material = NotifMaterialOh::create($validatedData);
    ...
    {
        $notif_material = NotifMaterialOh::find($id);
        if (!$notif_material) {
            return response()->json([
                'success' => false,
    ...
    {
        $notif_material = NotifMaterialOh::with(['readiness_material_oh'])->where('readiness_material_oh_id', $id)->orderby('id', 'desc')->get();
