...
use App\Models\NotifMaterialRtnrt;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class NotifMaterialRtnrtController extends Controller
{
    /**
    ...
    {
        $notif_material = NotifMaterialRtnrt::orderBy('id', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            $notif_material = NotifMaterialRtnrt::create($validatedData);
    ...
    {
        $notif_material = NotifMaterialRtnrt::find($id);
        if (!$notif_material) {
            return response()->json([
                'success' => false,
    ...
    {
        $notif_material = NotifMaterialRtnrt::with(['readiness_material_rtnrt'])->where('readiness_material_rtnrt_id', $id)->orderby('id', 'desc')->get();
