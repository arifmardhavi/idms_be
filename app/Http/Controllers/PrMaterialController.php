...
class PrMaterialController extends Controller
{
    /**
    ...
    {
        $pr_material = PrMaterial::orderBy('id', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            $pr_material = PrMaterial::create($validatedData);
    ...
    {
        $pr_material = PrMaterial::find($id);
    ...
    {
        $pr_material = PrMaterial::with(['readiness_material'])->where('readiness_material_id', $id)->orderby('id', 'desc')->get();
