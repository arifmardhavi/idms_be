...
use App\Models\DeliveryMaterialOh;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class DeliveryMaterialOhController extends Controller
{
    /**
    ...
    {
        $delivery_material = DeliveryMaterialOh::orderBy('id', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            if($request->hasFile('delivery_file')){
                $validatedData['delivery_file'] = FileHelper::uploadWithVersion($request->file('delivery_file'), 'readiness_oh/material/delivery/');
            }
            $delivery_material = DeliveryMaterialOh::create($validatedData);
    ...
    {
        $delivery_material = DeliveryMaterialOh::find($id);
    ...
    {
        $delivery_material = DeliveryMaterialOh::where('readiness_material_oh_id', $id)->orderby('id', 'desc')->get();
        ...
        try {
            if($request->hasFile('delivery_file')){
                ...
                if ($delivery_material->delivery_file) {
                    FileHelper::deleteFile($delivery_material->delivery_file, 'readiness_oh/material/delivery/');
                }
            }
