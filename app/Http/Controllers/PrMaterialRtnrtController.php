...
class PrMaterialRtnrtController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'readiness_material_rtnrt_id' => 'required|exists:readiness_material_rtnrts,id|unique:pr_material_rtnrts,readiness_material_rtnrt_id',
    ...
    public function update(Request $request, string $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            'readiness_material_rtnrt_id' => 'sometimes|exists:readiness_material_rtnrts,id|unique:pr_material_rtnrts,readiness_material_rtnrt_id,' . $id,
