...
use App\Models\PoMaterialRtnrt;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class PoMaterialRtnrtController extends Controller
{
    /**
    ...
    {
        $po_material = PoMaterialRtnrt::orderBy('id', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            $po_material = PoMaterialRtnrt::create($validatedData);
    ...
    {
        $po_material = PoMaterialRtnrt::with('readiness_material_rtnrt')->find($id);
        if (!$po_material) {
            return response()->json([
                'success' => false,
    ...
    {
        $po_material = PoMaterialRtnrt::with(['readiness_material_rtnrt'])->where('readiness_material_rtnrt_id', $id)->orderby('id', 'desc')->get();
    ...
    {
        $po_material = PoMaterialRtnrt::find($id);
        if (!$po_material) {
            return response()->json([
                'success' => false,
                'message' => 'PO Material not found.',
