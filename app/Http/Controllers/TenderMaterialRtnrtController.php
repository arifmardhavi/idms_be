...
use App\Models\TenderMaterialRtnrt;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class TenderMaterialRtnrtController extends Controller
{
    /**
    ...
    {
        $tender_material = TenderMaterialRtnrt::orderBy('id', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            $tender_material = TenderMaterialRtnrt::create($validatedData);
    ...
    {
        $tender_material = TenderMaterialRtnrt::find($id);
        if (!$tender_material) {
            return response()->json([
                'success' => false,
    ...
    {
        $tender_material = TenderMaterialRtnrt::with(['readiness_material_rtnrt'])->where('readiness_material_rtnrt_id', $id)->orderby('id', 'desc')->get();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            'readiness_material_rtnrt_id' => 'sometimes|required|exists:readiness_material_rtnrts,id',
