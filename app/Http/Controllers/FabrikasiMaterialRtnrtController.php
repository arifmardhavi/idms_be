...
use App\Models\FabrikasiMaterialRtnrt;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class FabrikasiMaterialRtnrtController extends Controller
{
    /**
    ...
    {
        $fabrikasi_material = FabrikasiMaterialRtnrt::orderBy('id', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            $fabrikasi_material = FabrikasiMaterialRtnrt::create($validatedData);
    ...
    {
        $fabrikasi_material = FabrikasiMaterialRtnrt::find($id);
    ...
    {
        $fabrikasi_material = FabrikasiMaterialRtnrt::where('readiness_material_rtnrt_id', $id)->orderby('id', 'desc')->get();
