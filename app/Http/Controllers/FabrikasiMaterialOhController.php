...
use App\Models\FabrikasiMaterialOh;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class FabrikasiMaterialOhController extends Controller
{
    /**
    ...
    {
        $fabrikasi_material = FabrikasiMaterialOh::orderBy('id', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            $fabrikasi_material = FabrikasiMaterialOh::create($validatedData);
    ...
    {
        $fabrikasi_material = FabrikasiMaterialOh::find($id);
    ...
    {
        $fabrikasi_material = FabrikasiMaterialOh::where('readiness_material_oh_id', $id)->orderby('id', 'desc')->get();
