...
use App\Models\TenderMaterialOh;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class TenderMaterialOhController extends Controller
{
    /**
    ...
    {
        $tender_material = TenderMaterialOh::orderBy('id', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            $tender_material = TenderMaterialOh::create($validatedData);
    ...
    {
        $tender_material = TenderMaterialOh::find($id);
        if (!$tender_material) {
            return response()->json([
                'success' => false,
    ...
    {
        $tender_material = TenderMaterialOh::with(['readiness_material_oh'])->where('readiness_material_oh_id', $id)->orderby('id', 'desc')->get();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            'readiness_material_oh_id' => 'sometimes|required|exists:readiness_material_ohs,id',
