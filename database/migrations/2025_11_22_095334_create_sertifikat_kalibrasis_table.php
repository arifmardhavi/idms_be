...
return new class extends Migration
{
    ...
    {
        Schema::create('sertifikat_kalibrasis', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('file_sertifikat_kalibrasi')->nullable();
            $table->text('file_old_sertifikat_kalibrasi')->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('sertifikat_kalibrasis');
    }
};
