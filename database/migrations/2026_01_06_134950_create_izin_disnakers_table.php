...
return new class extends Migration
{
    ...
    {
        Schema::create('izin_disnakers', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('izin_disnaker_certificate')->nullable();
            $table->string('izin_disnaker_old_certificate')->nullable();
    ...
    {
        Schema::dropIfExists('izin_disnakers');
    }
};
